...
class InTheNews extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:in-the-news';
    ...
    public function handle()
    {
        ...
        $oldNewsExcel = $this->formatExcelData('app/public/in-the-news/in-the-news.csv');
        ...
        $finalData = $oldNewsExcel->map(function ($item) use ($indexedSectors) {
             ...
             * ==============================================================
             */
            // if (! empty($item['perspective_business_sector'])) {
             ...
             * ==============================================================
             */
            if (! empty($item['wpcf-in-the-news-published-date'])) {
                $item['wpcf-in-the-news-published-date'] = $this->convertTimestampFormat($item['wpcf-in-the-news-published-date']);
            }
             ...
             * ==============================================================
             */
            if (! empty($item['in_the_news_summury'])) {
                // Use strip_tags to remove any HTML tags from the summary
                $item['in_the_news_summury'] = strip_tags($item['in_the_news_summury']);
            }
        ...
        $finalFilePath = 'public/build-in-the-news.csv';
    ...
    private function mapBusinessSector($item, $indexedSectors)
    {
        ...
        // If no sectors were matched, ensure 'updated_business_sector_id' is set to an empty string
        $item['updated_business_sector_id'] = ! empty($newIDs) ? implode('|', $newIDs) : '';
